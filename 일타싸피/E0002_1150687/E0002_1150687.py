...
while True:
    ...
    def func(targetBall_x, targetBall_y):
        global angle
        global power
    ...
    # 각 홀의 위치
    goals = [(0, 0), (127, 0), (254, 0), (0, 127), (127, 127), (254, 127)]

    if balls[1][0] != -1 and balls[3][0] == -1:
        # targetBall_x, targetBall_y: 목적구의 X, Y좌표를 나타내기 위해 사용한 변수
        targetBall_x = balls[1][0]
        targetBall_y = balls[1][1]

        func(targetBall_x, targetBall_y)

    elif balls[1][0] == -1 and balls[3][0] != -1 and balls[5][0] == -1:
        # targetBall_x, targetBall_y: 목적구의 X, Y좌표를 나타내기 위해 사용한 변수
